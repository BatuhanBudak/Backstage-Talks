...
export default function MainPage() {
    ...
    const [fourthdRef, inViewFourth] = useInView({
        threshold: 0.5,
    });
    ...
    return (
        <main className={className}>
            ...
            <Magazine id="three" issuePic={four} issueNumber={3} ref={fourthdRef} />
            <Magazine id="two" issuePic={five} issueNumber={2} ref={fifthRef} />
            <Magazine id="one" issuePic={six} issueNumber={1} ref={sixthRef} />
            {isDesktopScreen && <ul className='issues-menu'>
                <li><a href='#six'>Issue #6</a></li>
                <li><a href='#five'>Issue #5</a></li>
                <li><a href='#four'>Issue #4</a></li>
                <li><a href='#three'>Issue #3</a></li>
                <li><a href='#two'>Issue #2</a></li>
                <li><a href='#one'>Issue #1</a></li>
            </ul>}
